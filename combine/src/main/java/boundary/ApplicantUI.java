        ...
        try {
            ...
            while (true) {
                ...
                if (input.isEmpty()) {
                    ...
                    name = input; // Store valid input
                    break; // Exit the loop
                }
            }

            // --- Collect location with validation loop ---
            while (true) {
            ...
            // --- Collect job position with validation loop ---
            while (true) {
            ...
            // --- Process skills with validation (already uses a loop) ---
            while (true) {
            ...
            // --- Collect and validate CGPA (already uses a loop) ---
            while (true) {
