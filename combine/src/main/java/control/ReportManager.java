...
public class ReportManager {
    ...
    private void detailedReport() {
        ...
        if (choice == 1) {
            ...
            if (applicantsForJob.size() == 0) {
                ...
                displayApplicants(applicantsForJob);
            }
        } else if (choice == 2) {
            ...
            for (int i = 0; i < jobIds.size(); i++) {
                Job j = jobManager.getJobById(jobIds.get(i));
                displayJobDetails(j);
            }
            ...
            if (applicantsForCompany.size() == 0) {
                ...
                displayApplicants(applicantsForCompany);
            }
        } else {
    ...
    private ArrayList<Applicant> getApplicantsByJobId(String jobId) {
    ...
    private void displayApplicants(ArrayList<Applicant> applicants) {
        System.out.println("-----------------------------------------------------------------");
        System.out.printf("%-10s | %-15s | %-15s | %-15s |\n", 
                          "ID", "Name", "Location", "DesiredJobType");
        System.out.println("-----------------------------------------------------------------");
